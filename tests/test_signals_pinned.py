...
If this test fails you changed what Jev is asked. That is allowed, and it is
supposed to be deliberate: bump SIGNAL_SET_VERSION in models.py, update the
fingerprint below, and note the change. Do not just paste the new hash in.
"""
...
EXPECTED_FINGERPRINT = "9ed88219bfb741b5"
